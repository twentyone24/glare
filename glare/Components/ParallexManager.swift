...
extension View {
    func parallax(amount: CGFloat = 10, direction: ParallaxDirection = .both) -> some View {
        ParallaxView(
            view: AnyView(self),
            amount: amount,
            direction: direction
    ...
    func parallax(minHorizontal: CGFloat = -10, maxHorizontal: CGFloat = 10, minVertical: CGFloat = -10, maxVertical: CGFloat = 10, direction: ParallaxDirection = .both) -> some View {
        ParallaxView(
            view: AnyView(self),
